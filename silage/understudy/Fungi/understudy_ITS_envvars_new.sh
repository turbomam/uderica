export PROJ_GENE_TITLE="understudy_fungi"
export PROJ_GENE_HOME="/home/mark/gitstage/uderica/silage/understudy/Fungi"
...
export OTU_PICK_PARAM_FILE="${PROJ_GENE_HOME}/its-soils-tutorial_params.txt"
...
export PHYLOSEQ_OUTPUT_PREFIX="understudy_fungi"

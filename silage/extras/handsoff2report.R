...
# try other distance methods? (how to quanititate usefulness?)
ordination.dist <- "bray"

# how do you knwo (quanittitavely?) which is most meaningful?
ord_meths  <-
  c("DCA", "CCA", "RDA", "DPCoA", "NMDS", "MDS", "PCoA")

# useful to report all of these diversity emasures?
# how do you knwo (quanittitavely?) which is most meaningful?
# cramped plot!
alpha.div.measures <-
...
write.table(alpha.diversity, paste0("alpha_div_",  time.stamp, ".txt"))

...
if (experiment == "LalStress") {
  ...
  otufile <-
    paste0(
      '/home/mark/gitstage/uderica/silage/LalStress/Bacteria/raw_data_bacteria/flashed/extended/flash_trim_cat_pick/otu_table_mc2_w_tax_no_pynast_failures.biom'
    )
  ...
  otufile <-
    paste0(
      '/home/mark/gitstage/uderica/silage/V-HMC/Bacteria/raw_data_bacteria/flashed/extended/flash_trim_cat_pick/otu_table_mc2_w_tax_no_pynast_failures.biom'
    )
